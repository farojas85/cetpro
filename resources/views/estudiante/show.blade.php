...
<div id="estudiante-show" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="estudiante-showLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="estudiante-show-title">Mostrar Estudiante</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body" id="estudiante-show-body">
                <div class="row">
                    <div class="col-md-7">
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 text-right">Tipo Doc.</label>
                            <div class="col-md-9">
                                <select class="form-control" v-model="estudiante.tipo_documento_id" disabled>
                    ...
                    <div class="col-md-5">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9" title="Fecha Nacimiento">
                                <input type="date" v-model="estudiante.fecha_nacimiento" class="form-control" disabled>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-form-label col-md-3 text-right">Sexo</label>
                            <div class="col-md-9" title="Sexo">
                                <select class="form-control" v-model="estudiante.sexo" disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9" title="Teléfono">
                                <textarea class="form-control" v-model="estudiante.direccion" rows="3"
                                    placeholder="Dirección" title="Dirección" disabled ></textarea>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-footer" id="estudiante-show-footer">
