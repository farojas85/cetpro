...
<div id="estudiante-edit" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="estudiante-editLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="estudiante-edit-title">Nuevo Estudiante</h4>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
            </div>
            <div class="modal-body" id="estudiante-edit-body">
                <div class="row">
                    <div class="col-md-7">
            ...
            <div class="modal-footer" id="estudiante-edit-footer">
